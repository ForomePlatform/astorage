...
import org.forome.astorage.makedatabase.validation.ValidationDatabase;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

public class MainValidationDatabase {
    ...
    public static void main(String[] args) {
        try {
            ...
            ValidationDatabase validationDatabase = new ValidationDatabase(argumentsMake);
            validationDatabase.validation();
